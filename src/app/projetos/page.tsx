        ...
        <main className="projects">
            ...
            <div className="projects-grid">
                <div className="projects-grid-box">
                    <Image src={"/images/DespesasMobile.png"} alt={"Imagem do despesasMobile"} width={400} height={200}></Image>
                    <div className="projects-grid-box-wrapper">
                        <h2 className="projects-grid-box-wrapper-subtitle">Despesas Mobile</h2>
                        <p className="projects-grid-box-wrapper-text">Um simples projeto para controle de despesas que fiz para os meus pais</p>
                ...
                <div className="projects-grid-box">
                    <Image src={"/images/MeuWebsite.png"} alt={"Imagem do meu website"} width={400} height={200}></Image>
                    <div className="projects-grid-box-wrapper">
